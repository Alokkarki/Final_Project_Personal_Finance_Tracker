...
public class UpdateEmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonUpdateEmail.setEnabled(false);  //make button disable in the beginning until the user authenticates password
                    ...
                    firebaseUser.reauthenticate(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                           if (task.isSuccessful()){
                               ...
                               Toast.makeText(UpdateEmailActivity.this, "Password Verified" + "You can update email now", Toast.LENGTH_SHORT).show();
                               ...
                               //Disable EditText for password, button to verify user and enable EditText for new Email and email button
